...
class CertAdmConstants {
    ...
    public const Int32 CrPropPartitionedBaseCrlPublishStatus  = 0x00000031; // Partitioned Base CRL Publishing Status
    public const Int32 CrPropPartitionedDeltaCrlPublishStatus = 0x00000032; // Partitioned Delta CRL Publishing Status
    #endregion
